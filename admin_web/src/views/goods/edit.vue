  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="兑换所需青豆" prop="convertScore">
          <el-input v-model="goods.convertScore" placeholder="0.00" type="number"/>
        </el-form-item>

        <el-form-item label="购买商品赠送青豆" prop="giveScore">
          <el-input v-model="goods.giveScore" placeholder="0.00" type="number"/>
        </el-form-item>

        <el-form-item label="购买商品返上级佣金" prop="commission">
          <el-input v-model="goods.commission" placeholder="0.00" type="number"/>
        </el-form-item>
        ...
        <el-form-item label="关键字">
          ...
          <el-input v-if="newKeywordVisible" ref="newKeywordInput" v-model="newKeyword" class="input-new-keyword" @keyup.enter.native="handleInputConfirm"
      ...
      <el-dialog :visible.sync="specVisiable" title="设置规格">
        <el-form ref="specForm" :rules="rules" :model="specForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
          ...
          <el-form-item label="规格名" prop="specification">
            <el-input disabled v-model="specForm.specification" placeholder="标准 / 大 / 中 / 小 ……"/>
          </el-form-item>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="number" label="货品数量" type="number"/>
