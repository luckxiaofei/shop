...
import com.fei.common.util.SystemInfoPrinter;
...
//        configs = litemallSystemConfigService.queryAll();
...
//            litemallSystemConfigService.addConfig(entry.getKey(), entry.getValue());
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.com.fei.wx"));
