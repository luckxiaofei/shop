...
public class QCodeService {
    ...
    public String createFriendShareImage(Integer shareUserId) {
        try {
            //创建该商品的二维码
            File file = wxMaService.getQrcodeService().createWxaCodeUnlimit(shareUserId.toString(), "pages/index/index");
