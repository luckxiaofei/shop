...
public class SystemConfig {
    ...
    public final static String LITEMALL_WX_INDEX_CONVERT = "litemall_wx_index_convert";
    ...
    //推广规则配置
    public final static String BROWSE_GOODS_NUMBER = "browse_goods_number";
    public final static String BROWSE_GOODS_TIME = "browse_goods_time";
    public final static String NOTICE_INFO = "notice_info";
    public final static String RULE_INFO = "rule_info";
    public final static String SHARE_PROPORTION = "share_proportion";//分红比例
    ...
    public static Integer getConvertLimit() {
        return getConfigInt(LITEMALL_WX_INDEX_CONVERT);
    }
    ...
    public static String getBrowse_goods_number() {
        return getConfig(BROWSE_GOODS_NUMBER);
    }

    public static String getBrowse_goods_time() {
        return getConfig(BROWSE_GOODS_TIME);
    }

    public static String getNoticeInfo() {
        return getConfig(NOTICE_INFO);
    }
